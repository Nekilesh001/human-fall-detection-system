"""
Checkpoint Verification Script for Experiment K Phase K3 ST-GCN Graph Model.
Verifies all 4 trained K3 checkpoints for 100% exact match reproduction.
"""
...
from src.train_le2i_yolo_k3_stgcn import ModelK3_STGCN, YoloK3Dataset
from src.train_le2i_yolo_temporal import compute_metrics, set_seed

def evaluate_le2i_yolo_k3_stgcn():
    print("=" * 70)
    print("EXPERIMENT K PHASE K3: CHECKPOINT REPRODUCIBILITY AUDIT")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("ALL 4 K3 CHECKPOINTS VERIFIED — 100% EXACT REPRODUCTION PASSED [PASS]")
    print("=" * 70)

if __name__ == "__main__":
    evaluate_le2i_yolo_k3_stgcn()
